...
export default async function DashboardPage() {
  ...
  // Brands, projects, and assets arrive in Phases 3, 7, and 8. Until the
  // tables exist, this renders honest empty states rather than placeholder
  // data that would look like working features.
  return (
    <>
      <PageHeader
        title={`Welcome, ${displayNameFor(user)}`}
